...
# but also using 50 diffusion steps. Only doing 18k simulator steps cuz 50 diffusion
# steps takes hella long
#
########################################################
...
XLA_PYTHON_CLIENT_PREALLOCATE=false python OmniGibson/omnigibson/learning/eval.py \
    ...
    log_path="${LOG_DIR}/test_50_steps_receeding_horizon_29k_steps"
